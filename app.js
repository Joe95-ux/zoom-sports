...
// world cup livescore
app.get("/world-cup-livescore", async (req, res) => {
  const title = "world cup livescore";
  let sortedCats;
  try {
    let stories = await Story.find({ status: "Public" })
      .populate("user")
    ...
    res.render("wclivescore", { title, sortedCats });
  } catch (e) {
    console.log(e);
  }
});
...
// wc squads
app.get("/world-cup-squads", async (req, res) => {
  const title = "world cup squads";
  let sortedCats;
  try {
    let stories = await Story.find({ status: "Public" })
      .populate("user")
    ...
    res.render("wcsquad", { title, sortedCats });
  } catch (e) {
    console.log(e);
  }
});
...
app.get("/world-cup-standings", async (req, res) => {
  ...
  try {
    ...
    res.render("wcstandings", { title, sortedCats });
  } catch (e) {
    console.log(e);
  }
});
